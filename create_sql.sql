...
# Dump of table edp_action
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_action`;

CREATE TABLE `edp_action` (
...
# Dump of table edp_action_log
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_action_log`;

CREATE TABLE `edp_action_log` (
...
# Dump of table edp_addons
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_addons`;

CREATE TABLE `edp_addons` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
LOCK TABLES `edp_addons` WRITE;
/*!40000 ALTER TABLE `edp_addons` DISABLE KEYS */;

INSERT INTO `edp_addons` (`id`, `name`, `title`, `description`, `status`, `config`, `author`, `version`, `create_time`, `has_adminlist`)
VALUES
...
/*!40000 ALTER TABLE `edp_addons` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_attachment
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_attachment`;
...
# Dump of table edp_attribute
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_attribute`;

CREATE TABLE `edp_attribute` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `edp_attribute` WRITE;
/*!40000 ALTER TABLE `edp_attribute` DISABLE KEYS */;

INSERT INTO `edp_attribute` (`id`, `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`)
VALUES
...
/*!40000 ALTER TABLE `edp_attribute` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_auth_code
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_auth_code`;

CREATE TABLE `edp_auth_code` (
...
# Dump of table edp_auth_code_log
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_auth_code_log`;

CREATE TABLE `edp_auth_code_log` (
  ...
  `auth_code_ipaddr` varchar(50) DEFAULT NULL COMMENT 'IP',
  PRIMARY KEY (`auth_code_log_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;



# Dump of table edp_auth_extend
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_auth_extend`;

CREATE TABLE `edp_auth_extend` (
...
LOCK TABLES `edp_auth_extend` WRITE;
/*!40000 ALTER TABLE `edp_auth_extend` DISABLE KEYS */;

INSERT INTO `edp_auth_extend` (`group_id`, `extend_id`, `type`)
VALUES
	(1,1,1),
	(1,1,2),
	(1,2,1),
...
/*!40000 ALTER TABLE `edp_auth_extend` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_auth_group
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_auth_group`;

CREATE TABLE `edp_auth_group` (
...
LOCK TABLES `edp_auth_group` WRITE;
/*!40000 ALTER TABLE `edp_auth_group` DISABLE KEYS */;

INSERT INTO `edp_auth_group` (`id`, `module`, `type`, `title`, `description`, `status`, `rules`)
VALUES
	...
	(3,'admin',1,'edp','查看和配置会员',1,'1,220,221,222');

/*!40000 ALTER TABLE `edp_auth_group` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_auth_group_access
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_auth_group_access`;

CREATE TABLE `edp_auth_group_access` (
...
LOCK TABLES `edp_auth_group_access` WRITE;
/*!40000 ALTER TABLE `edp_auth_group_access` DISABLE KEYS */;

INSERT INTO `edp_auth_group_access` (`uid`, `group_id`)
VALUES
	(2,3),
	(3,3);

/*!40000 ALTER TABLE `edp_auth_group_access` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_auth_rule
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_auth_rule`;

CREATE TABLE `edp_auth_rule` (
...
LOCK TABLES `edp_auth_rule` WRITE;
/*!40000 ALTER TABLE `edp_auth_rule` DISABLE KEYS */;

INSERT INTO `edp_auth_rule` (`id`, `module`, `type`, `name`, `title`, `status`, `condition`)
VALUES
	...
	(219,'admin',1,'Admin/Clearcache/index','清除缓存',1,''),
	(220,'admin',1,'Admin/UserEdp/index','会员列表',1,''),
	(221,'admin',1,'Admin/UserType/index','会员类型管理',1,''),
	(222,'admin',2,'Admin/UserEdp/index','会员管理',1,'');

/*!40000 ALTER TABLE `edp_auth_rule` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_category
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_category`;

CREATE TABLE `edp_category` (
...
LOCK TABLES `edp_category` WRITE;
/*!40000 ALTER TABLE `edp_category` DISABLE KEYS */;

INSERT INTO `edp_category` (`id`, `name`, `title`, `pid`, `sort`, `list_row`, `meta_title`, `keywords`, `description`, `template_index`, `template_lists`, `template_detail`, `template_edit`, `model`, `model_sub`, `type`, `link_id`, `allow_publish`, `display`, `reply`, `check`, `reply_model`, `extend`, `create_time`, `update_time`, `status`, `icon`, `groups`)
VALUES
	(1,'blog','网站简介',0,0,10,'','','','','','','','2,3','2','2,1',0,0,1,0,0,'1','',1379474947,1482561033,1,0,''),
	(2,'default_blog','分类',1,1,10,'','','','','','','','2,3','2','2,1,3',0,1,1,0,1,'1','',1379475028,1482561040,0,0,'');

/*!40000 ALTER TABLE `edp_category` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_channel
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_channel`;

CREATE TABLE `edp_channel` (
...
LOCK TABLES `edp_channel` WRITE;
/*!40000 ALTER TABLE `edp_channel` DISABLE KEYS */;

INSERT INTO `edp_channel` (`id`, `pid`, `title`, `url`, `sort`, `create_time`, `update_time`, `status`, `target`)
VALUES
	(1,0,'首页','Index/index',1,1379475111,1379923177,1,0),
	(2,0,'博客','Article/index?category=blog',2,1379475131,1379483713,1,0);

/*!40000 ALTER TABLE `edp_channel` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_config
# ------------------------------------------------------------
...
LOCK TABLES `edp_config` WRITE;
/*!40000 ALTER TABLE `edp_config` DISABLE KEYS */;

INSERT INTO `edp_config` (`id`, `name`, `type`, `title`, `group`, `extra`, `remark`, `create_time`, `update_time`, `status`, `value`, `sort`)
VALUES
	(1,'WEB_SITE_TITLE',1,'网站标题',1,'','网站标题前台显示标题',1378898976,1379235274,1,'重庆公共管理学院',0),
	(2,'WEB_SITE_DESCRIPTION',2,'网站描述',1,'','网站搜索引擎描述',1378898976,1379235841,1,'重庆公共管理学院',1),
	(3,'WEB_SITE_KEYWORD',2,'网站关键字',1,'','网站搜索引擎关键字',1378898976,1381390100,1,'重庆大学,EDP',8),
...
/*!40000 ALTER TABLE `edp_config` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_document
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_document`;

CREATE TABLE `edp_document` (
...
LOCK TABLES `edp_document` WRITE;
/*!40000 ALTER TABLE `edp_document` DISABLE KEYS */;

INSERT INTO `edp_document` (`id`, `uid`, `name`, `title`, `category_id`, `group_id`, `description`, `root`, `pid`, `model_id`, `type`, `position`, `link_id`, `cover_id`, `display`, `deadline`, `attach`, `view`, `comment`, `extend`, `level`, `create_time`, `update_time`, `status`)
VALUES
	(1,1,'','OneThink1.1开发版发布',2,0,'期待已久的OneThink最新版发布',0,0,2,2,0,0,0,1,0,0,9,0,0,0,1406001413,1406001413,-1);

/*!40000 ALTER TABLE `edp_document` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_document_article
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_document_article`;

CREATE TABLE `edp_document_article` (
...
LOCK TABLES `edp_document_article` WRITE;
/*!40000 ALTER TABLE `edp_document_article` DISABLE KEYS */;

INSERT INTO `edp_document_article` (`id`, `parse`, `content`, `template`, `bookmark`)
VALUES
...
/*!40000 ALTER TABLE `edp_document_article` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_document_download
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_document_download`;

CREATE TABLE `edp_document_download` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文档ID',
  `parse` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '内容解析类型',
...
# Dump of table edp_file
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_file`;

CREATE TABLE `edp_file` (
...
# Dump of table edp_hooks
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_hooks`;

CREATE TABLE `edp_hooks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
LOCK TABLES `edp_hooks` WRITE;
/*!40000 ALTER TABLE `edp_hooks` DISABLE KEYS */;

INSERT INTO `edp_hooks` (`id`, `name`, `description`, `type`, `update_time`, `addons`, `status`)
VALUES
	...
	(13,'AdminIndex','首页小格子个性化显示',1,1382596073,'SiteStat,SystemInfo',1),
	(14,'topicComment','评论提交方式扩展钩子。',1,1380163518,'Editor',1),
	(16,'app_begin','应用开始',2,1384481614,'',1);

/*!40000 ALTER TABLE `edp_hooks` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_member
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_member`;

CREATE TABLE `edp_member` (
...
LOCK TABLES `edp_member` WRITE;
/*!40000 ALTER TABLE `edp_member` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `edp_member` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_menu
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_menu`;

CREATE TABLE `edp_menu` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '文档ID',
...
LOCK TABLES `edp_menu` WRITE;
/*!40000 ALTER TABLE `edp_menu` DISABLE KEYS */;

INSERT INTO `edp_menu` (`id`, `title`, `pid`, `sort`, `url`, `hide`, `tip`, `group`, `is_dev`, `status`)
VALUES
	...
	(124,'清除缓存',68,6,'Clearcache/index',0,'手动清除缓存','系统设置',1,1),
	(125,'会员管理',0,4,'UserEdp/index',0,'','',0,1),
	(126,'会员列表',125,1,'UserEdp/index',0,'','会员管理',0,1),
	(127,'会员类型管理',125,2,'UserType/index',0,'','会员管理',0,1);

/*!40000 ALTER TABLE `edp_menu` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_model
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_model`;

CREATE TABLE `edp_model` (
...
LOCK TABLES `edp_model` WRITE;
/*!40000 ALTER TABLE `edp_model` DISABLE KEYS */;

INSERT INTO `edp_model` (`id`, `name`, `title`, `extend`, `relation`, `need_pk`, `field_sort`, `field_group`, `attribute_list`, `attribute_alias`, `template_list`, `template_add`, `template_edit`, `list_grid`, `list_row`, `search_key`, `search_list`, `create_time`, `update_time`, `status`, `engine_type`)
VALUES
...
/*!40000 ALTER TABLE `edp_model` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_picture
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_picture`;

CREATE TABLE `edp_picture` (
...
# Dump of table edp_ucenter_admin
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_ucenter_admin`;

CREATE TABLE `edp_ucenter_admin` (
...
# Dump of table edp_ucenter_app
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_ucenter_app`;

CREATE TABLE `edp_ucenter_app` (
...
# Dump of table edp_ucenter_member
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_ucenter_member`;

CREATE TABLE `edp_ucenter_member` (
...
LOCK TABLES `edp_ucenter_member` WRITE;
/*!40000 ALTER TABLE `edp_ucenter_member` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `edp_ucenter_member` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_ucenter_setting
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_ucenter_setting`;

CREATE TABLE `edp_ucenter_setting` (
...
# Dump of table edp_url
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_url`;

CREATE TABLE `edp_url` (
...
# Dump of table edp_user_edp
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_user_edp`;

CREATE TABLE `edp_user_edp` (
  ...
  `last_ipaddr` varchar(256) DEFAULT NULL COMMENT '上次登录ip',
  `register_ip` varchar(256) DEFAULT NULL COMMENT '注册ip',
  `login_times` varchar(256) DEFAULT '1' COMMENT '登录次数',
  `reg_time` datetime DEFAULT NULL COMMENT '注册时间',
  `real_name` varchar(20) DEFAULT NULL COMMENT '姓名',
  `qq` varchar(20) DEFAULT NULL COMMENT 'QQ',
  `id_number` varchar(20) DEFAULT NULL COMMENT '身份证号',
  `gender` varchar(10) DEFAULT NULL COMMENT '性别',
  `user_type` varchar(10) DEFAULT NULL COMMENT '会员类型',
  ...
  `finish_school` varchar(20) DEFAULT NULL COMMENT '毕业时间',
  PRIMARY KEY (`user_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='EDP用户表';

LOCK TABLES `edp_user_edp` WRITE;
/*!40000 ALTER TABLE `edp_user_edp` DISABLE KEYS */;

/*!40000 ALTER TABLE `edp_user_edp` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_user_type
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_user_type`;

CREATE TABLE `edp_user_type` (
...
LOCK TABLES `edp_user_type` WRITE;
/*!40000 ALTER TABLE `edp_user_type` DISABLE KEYS */;

INSERT INTO `edp_user_type` (`user_type_id`, `type_value`, `mean`, `sort`)
VALUES
	(5,NULL,'普通会员',1);

/*!40000 ALTER TABLE `edp_user_type` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table edp_userdata
# ------------------------------------------------------------

DROP TABLE IF EXISTS `edp_userdata`;

CREATE TABLE `edp_userdata` (
  `uid` int(10) unsigned NOT NULL COMMENT '用户id',
